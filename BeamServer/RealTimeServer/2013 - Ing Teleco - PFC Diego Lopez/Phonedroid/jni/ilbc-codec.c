...
jint Java_com_example_phonedroid_Codec_init(
 ...
 *
 */
jint Java_com_example_phonedroid_Codec_encode(
 ...
 *
 */
jint Java_com_example_phonedroid_Codec_decode(
        JNIEnv *env, jobject this,
...
jint Java_com_example_phonedroid_ILBCCodecX_initEncode(
        JNIEnv *env, jobject this)
{
    initEncode(&g_enc_inst, 20);
    //initDecode(&g_dec_inst, 20, 1);
}

jint Java_com_example_phonedroid_ILBCCodecX_initDecode(
        JNIEnv *env, jobject this)
{
    //initEncode(&g_enc_inst, 20);
    initDecode(&g_dec_inst, 20, 1);
 ...
 *
 */
jint Java_com_example_phonedroid_ILBCCodecX_encode(
        JNIEnv *env, jobject this,
        jbyteArray sampleArray, jint sampleOffset, jint sampleLength,
        jbyteArray dataArray, jint dataOffset)
{
 ...
 *
 */
jint Java_com_example_phonedroid_ILBCCodecX_decode(
        JNIEnv *env, jobject this,
        jbyteArray dataArray, jint dataOffset, jint dataLength,
        jbyteArray sampleArray, jint sampleOffset)
{
...
jint Java_com_example_phonedroid_ILBCCodecY_initEncode(
        JNIEnv *env, jobject this)
{
    initEncode(&g_enc_inst, 30);
    //initDecode(&g_dec_inst, 30, 1);
}

jint Java_com_example_phonedroid_ILBCCodecY_initDecode(
        JNIEnv *env, jobject this)
{
    //initEncode(&g_enc_inst, 30);
    initDecode(&g_dec_inst, 30, 1);
 ...
 *
 */
jint Java_com_example_phonedroid_ILBCCodecY_encode(
        JNIEnv *env, jobject this,
        jbyteArray sampleArray, jint sampleOffset, jint sampleLength,
        jbyteArray dataArray, jint dataOffset)
{
 ...
 *
 */
jint Java_com_example_phonedroid_ILBCCodecY_decode(
        JNIEnv *env, jobject this,
        jbyteArray dataArray, jint dataOffset, jint dataLength,
        jbyteArray sampleArray, jint sampleOffset)
{
